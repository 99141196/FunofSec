...
def create_dh_key():
    ...
    a = random.randint(0, int(2**8))
        # this creates a random integer from zero to 2^8
    #print(a, a)
    return (a, a)
...
def calculate_dh_secret(their_public, my_private):
    ...
    shared_secret = their_public * my_private
        #Too wack, this is literally like saying instead of generators and stuff lets use multiplication
        #Are we supposed to go in and edit this crap to be ** instead? also mod?
