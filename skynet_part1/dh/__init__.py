...
#Debugging Commands Below, Ignore
#(my_public_key, my_private_key) = create_dh_key()
#my_public = first_stage_dh(Generator, aliceSecret)
#(their_public_key, their_private_key) = create_dh_key()
#shared_hash = calculate_dh_secret(my_public_key, their_private_key)
#print("my public:", my_public_key, "their private key:", their_private_key, "my private key:", my_private_key)
